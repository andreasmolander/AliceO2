...
void readFT0DCSentries(long ts = 9999999999000, const char* ccdb = "http://localhost:8080")
{
  ...
  std::unordered_map<o2::dcs::DataPointIdentifier, o2::ft0::FT0DCSinfo>* m = api.retrieveFromTFileAny<std::unordered_map<o2::dcs::DataPointIdentifier, o2::ft0::FT0DCSinfo>>("FT0/Calib/DCSDPs", metadata, ts);
